...
fignum = binner.plotPowerSpectrum(
    randomnodithermetricval, label='No Dither, w/Dipole', fignum=fignum, removeDipole=False)
...
fignum = binner.plotPowerSpectrum(
    onesnodithermetricval, label='No Dither, w/Dipole', fignum=fignum, removeDipole=False)
